...
----------------------------------------------------------------------------------------------
Singly Linear           SinglyLLnode                         SinglyLL         Done
Singly Circular         SinglyCLLnode                        SinglyCLL
Doubly Linear           DoublyLLnode                         DoublyLL         Done
...
//      Input :           Data of node
//      Output :          Nothing
//      Description:      User to insert node at first position
...
{
    cout<<"Linked List Get Created Successfully"<<"\n";
